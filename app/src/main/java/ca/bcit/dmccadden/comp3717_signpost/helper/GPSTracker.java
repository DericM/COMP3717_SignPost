...
import ca.bcit.dmccadden.comp3717_signpost.activity.MainActivity;
...
public class GPSTracker extends Service implements LocationListener {
    ...
    public void onLocationChanged(Location location) {
        historyActivity.getMessagesFromServer();
    }
    ...
    public boolean isInRange(double latitude, double longitude){
        if(latitude >= getLatitude()-20 && latitude <= getLatitude()+20 && longitude >= getLongitude()-20 && longitude <= getLongitude()+20)
            return true;
        else
            return false;
    }
